...
public class FakeDeviceSimulatorImpl implements FakeDeviceSimulator {
    ...
    private String generateRandomData() {
        ...
        int temperatureNetworkFormatted = temp * 10;
        int humidityNetworkFormatted = hum * 10;

        String temperature = Integer.toString(temperatureNetworkFormatted, 16);
        String humidity = Integer.toString(humidityNetworkFormatted, 16);
        String co2S = Integer.toString(co2, 16);
        String sounds = Integer.toString(sound, 16);

        String temperaturePadded = padLeftZeros(temperature, 4);
        String humidityPadded = padLeftZeros(humidity, 4);
        String co2Padded = padLeftZeros(temperature, 4);
        String soundPadded = padLeftZeros(humidity, 4);

        r = temperaturePadded + humidityPadded;
