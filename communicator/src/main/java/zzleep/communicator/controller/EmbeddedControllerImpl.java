...
public class EmbeddedControllerImpl implements EmbeddedController{
    ...
    public void start() {
        ...
        Thread progressThread = new Thread(this::run);
    ...
    private void receiveData(String s) {
        ...
        if (message.getCmd().equals("rx")) {
            ...
            // FIXME ZOLLY ASKED FOR IT, SHOULD BE REMOVED IN PRODUCTION
    ...
    private void receive(CurrentData data) {
        repository.insertCurrentData(data);
    }
