...
public class PersistenceRepositoryImpl implements PersistenceRepository {
    ...
    @Override
    public void insertCurrentData(CurrentData data) {
    ...
    public void insertVentilation(String deviceId) {
        context.insert(
    ...
    public void deleteVentilation(String deviceId) {
        context.delete(
            DatabaseConstants.ACTIVE_VENTILATION_TABLE,
            String.format(
                "%s = '%s'",
    ...
    public void insertActiveSleep(int sleepId) {
        context.insert(
            DatabaseConstants.ACTIVE_SLEEPS_TABLE,
            DatabaseConstants.ACTIVE_SLEEPS_COL_SLEEP_ID,
            "" + sleepId,
